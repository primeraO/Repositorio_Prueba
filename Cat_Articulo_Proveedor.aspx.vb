Imports System.Data
Partial Class Cat_Articulo_Proveedor
    ...
    Private Function Llena_DataTable() As DataTable
        ...
        Try
            ...
            G.cn.Open()
            G.Tsql = "Select Art_Numero,Pro_Numero "
            G.Tsql &= " ,(Select top 1 Razon_Social From Proveedor Where Numero=a.Pro_Numero) As Prov_Nombre"
            G.Tsql &= " ,(Select top 1 Art_Descripcion From Articulos  Where Numero=a.Art_Numero) As Art_Descripcion"
    ...
    Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridView1.RowCommand
        If (e.CommandName.Equals("Baja")) Or (e.CommandName.Equals("Cambio")) Then
            ...
            If Not f Is Nothing Then
                ...
                G.cn.Open()
                G.Tsql = "Select Unidad_Medida,Moneda,Dias_Entrega,Garantia,Precio1,Fecha_Precio1,Impuesto"
                G.Tsql &= ",(Select top 1 Descripcion From Moneda Where Moneda=a.Moneda) As Moneda_Descripcion"
                G.Tsql &= "  From Articulo_Proveedor a"
                G.Tsql += " Where baja<>'*'"
                G.Tsql &= " and Art_Numero=" & Pone_Apos(T_Articulo.Text)
                G.Tsql &= " and Pro_Numero=" & Val(T_Proveedor.Text)
                G.Tsql &= " and Cia=" & Val(Session("Cia"))
                ...
                If G.dr.HasRows Then
                    T_Moneda.Text = G.dr("Moneda").ToString
                    T_Unidad_Medida.Text = G.dr("Unidad_Medida").ToString
                    T_Dias_Entrega.Text = G.dr("Dias_Entrega").ToString
                    T_Garantia.Text = G.dr("Garantia").ToString
                    T_Precio_Lista.Text = For_Pan_Lib(G.dr("Precio1").ToString, 2)
                    T_Fecha_Vigencia.Text = G.dr("Fecha_Precio1").ToString
                    T_IVA.Text = G.dr("Impuesto").ToString
                    T_Moneda_Descripcion.Text = G.dr("Moneda_Descripcion")
                End If
                G.cn.Close()
            End If
    ...
    Protected Sub Btn_Guarda_Click(sender As Object, e As System.EventArgs) Handles Btn_Guarda.Click
        ...
        Try
            ...
            If Movimiento.Value = "Alta" Then
                G.cn.Open()
                G.Tsql = "Insert Into Articulo_Proveedor(Art_Numero,Pro_Numero,Dias_Entrega,Garantia,Precio1,Costo1"
