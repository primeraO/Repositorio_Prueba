<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Catalogo_Lugar_Entrega.aspx.vb" Inherits="Catalogo_Lugar_Entrega" %>
            ...
            <div>
                ...
                <asp:Panel ID="Panel1" runat="server" HorizontalAlign="Center">
                                    <asp:Label ID="Label25" runat="server" CssClass="Textos_Encabezado_Azul" 
                                        Text="Catálogo Lugar de Entrega" Width="95%"></asp:Label>
                                <br />
                                </asp:Panel>
                    ...
                    <table style="width:100%;">
                        <tr>
                            ...
                            <td style="text-align: right; " width="35%">
                                ...
                                placeholder="Descripcion" CssClass="form-control" MaxLength="50"></asp:TextBox>
                            </td>
           ...
           <div style="overflow-y:scroll; overflow-x:hidden; width:100%; height:500px;">
            <asp:GridView ID="GridView1" runat="server" 
                ...
                <asp:Panel ID="Pnl_Registro" CssClass="Paneles" runat="server">
                    <table style="width:100%;">
                        <tr>
                            <td style="text-align: left" width="11%" class="style2">
                                &nbsp;</td>
                 ...
                 style="text-align:right;top: 493px; left: 645px; " MaxLength="4" TabIndex="1" 
                            ...
                            <td style="text-align: right" height="40px" width="50px">
                                <asp:Label ID="Label17" runat="server" BorderStyle="None" Text="Descripcion:" 
                                CssClass="Textos_Azules"></asp:Label>
                            </td>
                    ...
                    MaxLength="50" TabIndex="17" CssClass="form-control" Width="340px"></asp:TextBox>
                            </td>
