<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Catalogo_Actividad_Area.aspx.vb" Inherits="Catalogo_Actividad_Area" %>
...
<link href="Ejemplo_Estilos.css" rel="stylesheet" type="text/css" />
    ...
    <script type="text/javascript">
        ...
        function Area(elemValue1, elemValue2) {
            document.getElementById('<%= T_Area.ClientID %>').value = elemValue1;
            document.getElementById('<%= T_Area_Desc.ClientID %>').value = elemValue2;
            __doPostBack("T_Area", "TextChanged");
        }
            ...
            <div>
                ...
                <asp:Panel ID="Panel1" runat="server" HorizontalAlign="Center">
                                    <asp:Label ID="Label25" runat="server" CssClass="Textos_Encabezado_Azul" 
                                        Text="Catálogo Concepto" Width="95%"></asp:Label>
                                <br />
                                </asp:Panel>
                    ...
                    <asp:Panel ID="Pnl_Grids" runat="server" HorizontalAlign="Left" Visible="False">
                        <div style="overflow:hidden; height:35px; width:100%; float:left">
                            <asp:GridView ID="Cabecera" runat="server" AutoGenerateColumns="False" 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Descripción de Actividad">
                        ...
                        <div style="overflow-y:scroll; overflow-x:hidden; width:100%; height:500px;">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                CellPadding="1" CellSpacing="4" DataKeyNames="Area,Actividad" Font-Size="Small" 
                                ForeColor="#333333" GridLines="None" Height="16px" ShowHeader="False" 
                                style="top: 152px; margin-left: 0px;" Visible="False" Width="964px">
                                <RowStyle BackColor="#EFF3FB" Height="22px" />
                                <Columns>
                                    <asp:CommandField ShowSelectButton="True" Visible="False">
                                    <ItemStyle Width="40px" />
                                    </asp:CommandField>
                                    <asp:BoundField DataField="Area" HeaderText="Num.">
                                    <ItemStyle HorizontalAlign="Right" Width="40px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="Descripcion_Area" HeaderText="Área">
                                    <ItemStyle HorizontalAlign="Left" Width="377px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="Actividad">
                                    <ItemStyle HorizontalAlign="Right" Width="50px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="Descripcion_Actividad" HeaderText="Actividad">
                                    <ItemStyle HorizontalAlign="Left" Width="367px" />
                                    </asp:BoundField>
                    ...
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td align="left" width="10%">
                                <asp:Label ID="Label26" runat="server" CssClass="Textos_Azules" Text="Área"></asp:Label>
                                &nbsp;
                            </td>
                            <td class="style7">
                                <asp:TextBox ID="T_Area" runat="server" CssClass="form-control" 
                                Width="50px" TabIndex="1"  text-align="right" AutoPostBack="True"></asp:TextBox>
                            </td>
                            ...
                            <td align="left" class="style9">
                                <asp:TextBox ID="T_Area_Desc" runat="server" MaxLength="50" 
