<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Catalogo_Marca.aspx.vb" Inherits="Catalogo_Marca" %>
            ...
            <div>
                ...
                <asp:Panel ID="Panel1" runat="server" HorizontalAlign="Center">
                                    <asp:Label ID="Label25" runat="server" CssClass="Textos_Encabezado_Azul" 
                                        Text="Catálogo Marca" Width="95%"></asp:Label>
                                <br />
                                </asp:Panel>
                    ...
                    <table style="width:100%;">
                        <tr>
                            ...
                            <td width="9%" style="text-align: left">
                                <asp:TextBox ID="TB_Numero" runat="server" Width="58px" TabIndex="13" placeholder="Num." 
                                CssClass="form-control" Height="18px" 
                                MaxLength="4" style="text-align: right; "></asp:TextBox>
                            </td>
                            <td width="4%" style="text-align: left">
                                &nbsp;</td>
                            <td style="text-align: right; " width="35%">
                                <asp:TextBox ID="TB_Descripcion" runat="server" Width="288px" TabIndex="14" 
                                placeholder="Marca" CssClass="form-control" 
                                Height="18px" MaxLength="35"></asp:TextBox>
                            </td>
                            <td style="text-align: left; " width="30%">
                                &nbsp;&nbsp;
                                <asp:CheckBox ID="Ch_Baja" runat="server" CssClass="Textos_Azules" 
                                Text="Bajas" AutoPostBack="True" TabIndex="15" />
                            </td>
                            <td width="11%">
                            </td>
                        </tr>
                    ...
                    <table style="width:100%;">
                        <tr>
                            <td style="text-align: left" width="100">
                                &nbsp;</td>
                            <td style="text-align: left" height="40px" width="30px">
                                <asp:Label ID="Label16" runat="server" BorderStyle="None" Text="Núm." 
                                CssClass="Textos_Azules"></asp:Label>
                            </td>
                            <td style="text-align: left" height="40px" width="80px">
                                <asp:TextBox ID="T_Numero" runat="server" 
                 style="text-align:right;top: 493px; left: 645px; " MaxLength="4" TabIndex="1" 
                                Width="30px" CssClass="form-control" 
                                ReadOnly="True" Height="18px"></asp:TextBox>
                            </td>
                            <td style="text-align: right" height="40px" width="50px">
                                <asp:Label ID="Label17" runat="server" BorderStyle="None" Text="Marca:" 
                                CssClass="Textos_Azules"></asp:Label>
                            </td>
                            <td style="text-align: left" height="40px" width="150px">
                                <asp:TextBox ID="T_Descripcion" runat="server" 
                      style="top: 550px; left: 155px; right: 66px; bottom: 70px;" 
                    MaxLength="35" TabIndex="3" CssClass="form-control" Width="180px" 
                                Height="18px"></asp:TextBox>
                            </td>
                            <td style="text-align: right" height="40px" width="90px">
                                <asp:Label ID="Label24" runat="server" BorderStyle="None" Text="Aplicación:" 
                                CssClass="Textos_Azules"></asp:Label>
                            </td>
                            <td style="text-align: left" height="40px" width="340px">
                                <asp:TextBox ID="T_Aplicacion" runat="server" MaxLength="50" 
                        style="top: 481px; left: 10px; text-align: left;" 
                        TabIndex="4" CssClass="form-control" Width="200px" 
                                Height="18px"></asp:TextBox>
                            </td>
          ...
          <asp:Panel ID="Pnl_Grids" runat="server" HorizontalAlign="Left" Visible="False">
           ...
           <div style="overflow-y:scroll; overflow-x:hidden; width:100%; height:500px;">
            <asp:GridView ID="GridView1" runat="server" 
                AutoGenerateColumns="False" CellPadding="1" ForeColor="#333333" 
                GridLines="None" 
                 style="top: 152px; left: 86px; " DataKeyNames="Marca" Font-Size="Small" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Marca" HeaderText="Núm." >
                    <ItemStyle HorizontalAlign="Right" Width="50px"/>
                    </asp:BoundField>
                    <asp:BoundField DataField="Descripcion" HeaderText="Marca" >
                    <ItemStyle Width="594px"/>
                    </asp:BoundField>
