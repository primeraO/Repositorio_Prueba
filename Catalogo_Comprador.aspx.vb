...
Partial Class Catalogo_Comprador
    ...
    Private Sub CrearCamposTabla()
        ...
        clave(0) = Session("dt").Columns("Comprador")
    ...
    Private Function LLena_Datatable() As DataTable
        ...
        Try
            ...
            G.cn.Open()
            G.Tsql = "Select Comprador,Nombre from Comprador "
            G.Tsql &= " Where Comprador<>0 "
    ...
    Private Function Siguiente() As Integer
        ...
        Try
            G.cn.Open()
            G.Tsql = "Select Max(Comprador) from Comprador"
            G.com.CommandText = G.Tsql
    ...
    Private Function validar() As Boolean
        ...
        If T_Descripcion.Text.Trim = "" Then
            Msg_Error("Nombre inválida") : Exit Function
        End If
        Return True
    End Function
    ...
    Protected Sub Ima_Guarda_Click(sender As Object, e As System.EventArgs) Handles Ima_Guarda.Click
        ...
        Try
            ...
            If Movimiento.Value = "Alta" Then
                T_Numero.Text = Siguiente()
                G.cn.Open()
                Tsql = "Select Nombre from Comprador where Nombre=" & Pone_Apos(T_Descripcion.Text)
                G.com.CommandText = Tsql
                If Not G.com.ExecuteScalar Is Nothing Then
                    Msg_Error("Ya existe el Nombre del Comprador") : Exit Sub
                End If
                G.Tsql = "Insert into Comprador (Cia,Obra,Comprador,Nombre,Cve_Seg,Fecha_Seg,Hora_Seg,Baja) values ("
            ...
            If Movimiento.Value = "Cambio" Then
                ...
                G.Tsql &= ",Nombre=" & Pone_Apos(T_Descripcion.Text.Trim)
                ...
                G.Tsql &= " and Comprador = " & Val(T_Numero.Text.Trim)
                G.com.CommandText = G.Tsql
                G.com.ExecuteNonQuery()
    ...
    Protected Sub GridView1_RowCommand(sender As Object, e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridView1.RowCommand
        If (e.CommandName.Equals("Baja")) Or (e.CommandName.Equals("Cambio")) Or (e.CommandName.Equals("Seleccion")) Then
            ...
            Dim f As DataRow = Session("dt").Rows.Find(Clave)
            If Not f Is Nothing Then
                T_Numero.Text = f.Item("Comprador")
    ...
    Protected Sub GridView1_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles GridView1.SelectedIndexChanged
        Dim clave(0) As String
        clave(0) = GridView1.DataKeys(GridView1.SelectedIndex).Item("Comprador").ToString
        Dim f As DataRow = Session("dt").Rows.Find(clave)
        If Not f Is Nothing Then
            T_Numero.Text = f.Item("Comprador")
            T_Descripcion.Text = f.Item("Nombre")
