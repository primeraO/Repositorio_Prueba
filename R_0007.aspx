<%@ Page Language="VB" AutoEventWireup="false" CodeFile="R_0007.aspx.vb" Inherits="R_0007" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function Sublineas(elemValue1, elemValue2, elemValue3) {
            if (elemValue3 == "2") {
                document.getElementById('<%= T_Sublinea_Final.ClientID %>').value = elemValue1;
                document.getElementById('<%= T_Sub_Desc_Final.ClientID %>').value = elemValue2;
                __doPostBack("T_Sublinea_Final", "TextChanged");
            }
            else {
                document.getElementById('<%= T_Sublinea_Inicial.ClientID %>').value = elemValue1;
                document.getElementById('<%= T_Sub_Desc_Inicial.ClientID %>').value = elemValue2;
                __doPostBack("T_Sublinea_Inicial", "TextChanged");
            }
        }

        function Lineas(elemValue1, elemValue2, Num_Prov) {
            if (Num_Prov == "1") {
                document.getElementById('<%= T_Linea_Inicial.ClientID %>').value = elemValue1;
                document.getElementById('<%= T_Linea_Desc_Inicial.ClientID %>').value = elemValue2;
                __doPostBack("T_Linea_Inicial", "TextChanged");
            } else if (Num_Prov == "2") {
                document.getElementById('<%= T_Linea_Final.ClientID %>').value = elemValue1;
                document.getElementById('<%= T_Linea_Desc_Final.ClientID %>').value = elemValue2;
                __doPostBack("T_Linea_Final", "TextChanged");
            }
        }
    </script>
                        ...
                        <td width="60%">
                            <asp:Panel ID="Panel1" runat="server" Height="90px" HorizontalAlign="Center">
                                <asp:Label ID="Label25" runat="server" CssClass="Textos_Encabezado_Azul" 
                                    Height="40px" Text="Reporte Existencias Físicas"></asp:Label>
                                <br />
        ...
        <div>
                ...
                <asp:Panel ID="Panel2" runat="server" CssClass="Paneles">
                    ...
                    <table style="width:100%;">
                        <tr>
                            <td width="90px">
                                <asp:Label ID="Label32" runat="server" CssClass="Textos_Azules" Text="Fecha"></asp:Label>
                            </td>
                            <td width="100px">
                                <asp:TextBox ID="T_Fecha_Ini" runat="server" AutoPostBack="True" 
                                    CssClass="form-control" Width="100px"></asp:TextBox>
                            </td>
                            <td width="20px">
                                <rjs:PopCalendar ID="Fecha_Ini" runat="server" Control="T_Fecha_Ini" 
                            ...
                            <td width="5px">
                                &nbsp;</td>
                            <td width="100px">
                                <asp:TextBox ID="T_Fecha_Fin" runat="server" AutoPostBack="True" 
                                    CssClass="form-control" Width="100px"></asp:TextBox>
                            </td>
                            <td width="20px">
                                <rjs:PopCalendar ID="Fecha_Fin" runat="server" Control="T_Fecha_Fin" 
                                    Format="yyyy mm dd" Separator="/" />
                            </td>
                            <td width="250px">
                                &nbsp;</td>
                        ...
                        <tr>
                            <td width="90px">
                                <asp:Label ID="Label31" runat="server" CssClass="Textos_Azules" Text="Línea"></asp:Label>
                            </td>
                            <td width="100px">
                                <asp:TextBox ID="T_Linea_Inicial" runat="server" AutoPostBack="True" 
                                    CssClass="form-control" Width="100px"></asp:TextBox>
                            </td>
                            <td width="20px">
                                <asp:ImageButton ID="Btn_Linea_Inicial" runat="server" 
                                    ImageUrl="~/Imagenes/M_Buscar_50.png" TabIndex="5" Width="29px" />
                            </td>
                            <td width="250px">
                                <asp:TextBox ID="T_Linea_Desc_Inicial" runat="server" 
                                    CssClass="form-control-Readonly" Width="255px"></asp:TextBox>
                            </td>
                            <td width="5px">
                                &nbsp;</td>
                            <td width="100px">
                                <asp:TextBox ID="T_Linea_Final" runat="server" AutoPostBack="True" 
                                    CssClass="form-control" Width="100px"></asp:TextBox>
                            </td>
                            <td width="20px">
                                <asp:ImageButton ID="Btn_Linea_Final" runat="server" 
                                    ImageUrl="~/Imagenes/M_Buscar_50.png" TabIndex="5" Width="29px" />
                            </td>
                            <td width="250px">
                                <asp:TextBox ID="T_Linea_Desc_Final" runat="server" 
                                    CssClass="form-control-Readonly" Width="255px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td width="90px">
                                <asp:Label ID="Label28" runat="server" CssClass="Textos_Azules" Text="Sublínea" 
                                    Visible="False"></asp:Label>
                            </td>
                            <td width="100px">
                                <asp:TextBox ID="T_Sublinea_Inicial" runat="server" AutoPostBack="True" 
                                    CssClass="form-control" Visible="False" Width="100px"></asp:TextBox>
                            </td>
                            <td width="20px">
                                <asp:ImageButton ID="Btn_Sublinea_Inicial" runat="server" 
                                    ImageUrl="~/Imagenes/M_Buscar_50.png" TabIndex="5" Visible="False" 
                                    Width="29px" />
                            </td>
                            <td width="250px">
                                <asp:TextBox ID="T_Sub_Desc_Inicial" runat="server" 
                                    CssClass="form-control-Readonly" Visible="False" Width="255px"></asp:TextBox>
                            </td>
                            <td width="5px">
                                &nbsp;</td>
                            <td width="100px">
                                <asp:TextBox ID="T_Sublinea_Final" runat="server" AutoPostBack="True" 
                                    CssClass="form-control" Visible="False" Width="100px"></asp:TextBox>
                            </td>
                            <td width="20px">
                                <asp:ImageButton ID="Btn_Sublinea_Final" runat="server" 
                                    CssClass="Btn_Proveedor" ImageUrl="~/Imagenes/M_Buscar_50.png" TabIndex="5" 
                                    Visible="False" Width="29px" />
                            </td>
                            <td width="250px">
                                <asp:TextBox ID="T_Sub_Desc_Final" runat="server" 
                                    CssClass="form-control-Readonly" Visible="False" Width="255px"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
