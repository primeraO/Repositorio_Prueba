<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Catalogo_Terceros.aspx.vb" Inherits="Catalogo_Terceros" %>
            ...
            <div>
                ...
                <asp:Panel ID="Panel1" runat="server" HorizontalAlign="Center">
                                    <asp:Label ID="Label25" runat="server" CssClass="Textos_Encabezado_Azul" 
                                        Text="Catálogo Terceros" Width="95%"></asp:Label>
                                <br />
                                </asp:Panel>
                            ...
                            <tr style="height: 40px">
                                ...
                                <td class="style2" style="text-align: left">
                                    <asp:TextBox ID="TB_Numero" runat="server" CssClass="form-control" 
                                        placeholder="Num." style="text-align:right;" Width="56px"></asp:TextBox>
                                </td>
                                <td style="text-align: left" width="4%">
                                    &nbsp;</td>
                                <td style="text-align: left" width="35%">
                                    <asp:TextBox ID="TB_Descripcion" runat="server" Width="287px" 
                                CssClass="form-control" placeholder="Descripcion"></asp:TextBox>
                                </td>
                        ...
                        <asp:Panel ID="Pnl_Grids" runat="server" HorizontalAlign="Left" Visible="False">
                            <div style="overflow:hidden; height:35px; width:100%; float:left">
                                <asp:GridView ID="Cabecera" runat="server" AutoGenerateColumns="False" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="Tercero">
                            ...
                            <div style="overflow-y:scroll; overflow-x:hidden; width:100%; height:500px;">
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                    CellPadding="2" CellSpacing="4" DataKeyNames="Tercero" Font-Size="Small" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Tercero" HeaderText="Num.">
                                        <ItemStyle HorizontalAlign="Right" Width="50px" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="Descripcion" HeaderText="Tercero">
                        ...
                        <table style="width:100%;">
                            <tr>
                                ...
                                <td style="text-align: left" class="style1">
                                    <asp:Label ID="Label2" runat="server" CssClass="Textos_Azules" Text="Num."></asp:Label>
                                </td>
                            ...
                            <tr>
                                <td style="text-align: left" class="style1">
                                    &nbsp;</td>
                                <td style="text-align: left" class="style1">
                                    <asp:Label ID="Label3" runat="server" CssClass="Textos_Azules" Text="Tercero"></asp:Label>
                                </td>
