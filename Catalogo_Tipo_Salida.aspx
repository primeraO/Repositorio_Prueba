<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Catalogo_Tipo_Salida.aspx.vb" Inherits="Catalogo_Tipo_Salida" %>
            ...
            <div>
                ...
                <asp:Panel ID="Panel1" runat="server" HorizontalAlign="Center">
                                    <asp:Label ID="Label25" runat="server" CssClass="Textos_Encabezado_Azul" 
                                        Text="Catálogo Tipo de Salida" Width="95%"></asp:Label>
                                <br />
                                </asp:Panel>
                    ...
                    <table style="width:100%;">
                        <tr>
                            ...
                            <td style="text-align: left" width="35%">
                                <asp:TextBox ID="TB_Descripcion" runat="server" Width="78%" TabIndex="14" 
                        placeholder="Descripcion" CssClass="form-control" 
                    ...
                    <asp:Panel ID="Pnl_Grids" runat="server" HorizontalAlign="Left" Visible="False">
                        <div style="overflow:hidden; height:35px; width:100%; float:left">
                            <asp:GridView ID="Cabecera" runat="server" AutoGenerateColumns="False" 
                                ...
                                <Columns>
                                    ...
                                    <HeaderStyle Width="494px" />
                                    </asp:BoundField>
                                    <asp:BoundField HeaderText="Catalogo">
                                    <HeaderStyle Width="100px" />
                                    </asp:BoundField>
                                    <asp:BoundField HeaderText="Clasifica">
                                    <HeaderStyle Width="100px" />
                                    </asp:BoundField>
                        ...
                        <div style="overflow-y:scroll; overflow-x:hidden; width:100%; height:500px;">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                CellPadding="1" CellSpacing="4" DataKeyNames="Tipo" Font-Size="Small" 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Tipo" HeaderText="Num.">
                                    <ItemStyle HorizontalAlign="Right" Width="50px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="Descripcion" HeaderText="Descripcion">
                                    <ItemStyle HorizontalAlign="Left" Width="494px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="Catalogo" HeaderText="Catalogo">
                                    <ItemStyle HorizontalAlign="Right" Width="100px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="Clasifica" HeaderText="Clasifica">
                ...
                <asp:Panel ID="Pnl_Registro" CssClass="Paneles" runat="server">
                 ...
                 style="text-align:right;top: 493px; left: 645px; " 
                MaxLength="10" TabIndex="1" Width="50px" CssClass="form-control" 
                                Height="18px"></asp:TextBox>
                            </td>
                            <td style="text-align: left" width="11%">
                                &nbsp;</td>
                        ...
                        <tr>
                            <td style="text-align: left" width="11%">
                                &nbsp;</td>
                            <td style="text-align: left" height="40px" class="style2">
                                <asp:Label ID="Label24" runat="server" BorderStyle="None" Text="Tipo de Salida" 
                                CssClass="Textos_Azules"></asp:Label>
                            </td>
                            <td style="text-align: left" width="68%" height="40px">
                    ...
                    <table style="width:100%;">
                        <tr>
                            ...
                            <td class="style2" style="text-align: left">
                                <asp:Label ID="Label26" runat="server" CssClass="Textos_Azules" Text="Catalogo"></asp:Label>
                            </td>
                            <td style="text-align: left">
                                <asp:TextBox ID="T_Catalogo" runat="server" CssClass="form-control" 
                                    Height="18px" style="text-align:right;" TabIndex="3" Width="45%"></asp:TextBox>
                            </td>
                            <td style="text-align: left" width="10%">
                                <asp:Label ID="Label27" runat="server" CssClass="Textos_Azules" 
                                    Text="Clasifica"></asp:Label>
                            </td>
                            <td class="style7" style="text-align: left">
                                <asp:CheckBox ID="Ch_Clasifica" runat="server" Text="Si" />
                            </td>
                            <td style="text-align: left" width="10%">
                            ...
                            <td class="style8" style="text-align: left">
                                <asp:CheckBox ID="Ch_Referencia" runat="server" Text="Si" />
                            </td>
                            <td width="11%">
                                &nbsp;</td>
                        </tr>
