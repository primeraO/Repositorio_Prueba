<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Catalogo_Obras.aspx.vb" Inherits="Catalogo_Obras" %>
                            ...
                            <td width="70%">
                                <asp:Panel ID="Panel1" runat="server" HorizontalAlign="Center">
                                    <asp:Label ID="Label25" runat="server" CssClass="Textos_Encabezado_Azul" 
                                        Text="Catálogo de Proyectos" Width="100%"></asp:Label>
                                <br />
                                </asp:Panel>
                            </td>
            ...
            <div>
                ...
                <table style="width:100%;">
                 ...
                 style="top: 493px; left: 645px; " MaxLength="5" TabIndex="8" 
                                Width="130px" CssClass="form-control"></asp:TextBox>
                        </td>
                        <td style="text-align: left" width="11%">
                            &nbsp;</td>
                    </tr>
                    <tr>
                        <td style="text-align: left" width="11%">
                            &nbsp;</td>
                        <td style="text-align: left" width="10%">
                            <asp:Label ID="Label24" runat="server" BorderStyle="None" Text="Nombre" 
                                CssClass="Textos_Azules"></asp:Label>
                        </td>
                        <td style="text-align: left" width="68%">
                            <asp:TextBox ID="T_Descripcion" runat="server" MaxLength="70" 
                        style="top: 481px; left: 10px; text-align: left;" 
                        TabIndex="9" CssClass="form-control" Width="76%"></asp:TextBox>
                        </td>
                        <td style="text-align: left" width="11%">
                            <br />
                        </td>
                     ...
                     <table style="width:100%;">
                        ...
                        <td style="text-align: left">
                            <asp:TextBox ID="T_Direccion" runat="server" CssClass="form-control" 
                                Width="99%" MaxLength="250" TabIndex="10"></asp:TextBox>
                        </td>
                        <td width="11%">
                            &nbsp;</td>
                    </tr>
                ...
                <table style="width:100%;">
                    <tr>
                        ...
                        <td style="text-align: left">
                            <asp:TextBox ID="T_Colonia" runat="server" CssClass="form-control" 
                                MaxLength="50" TabIndex="11" Width="80%"></asp:TextBox>
                        </td>
                        <td class="style9" style="text-align: left">
                            <asp:Label ID="Label28" runat="server" CssClass="Textos_Azules" Text="Ciudad"></asp:Label>
                        </td>
                        <td style="text-align: left">
                            <asp:TextBox ID="T_Ciudad" runat="server" CssClass="form-control" 
                                MaxLength="30" TabIndex="12" Width="80%"></asp:TextBox>
                        </td>
                        <td width="11%">
                            &nbsp;</td>
                    </tr>
                    <tr>
                        <td>
                            &nbsp;</td>
                        <td style="text-align: left" class="style7">
                            <asp:Label ID="Label29" runat="server" CssClass="Textos_Azules" Text="Estado"></asp:Label>
                        </td>
                        <td style="text-align: left">
                            <asp:TextBox ID="T_Estado" runat="server" CssClass="form-control" 
                                MaxLength="50" TabIndex="13" Width="80%"></asp:TextBox>
                        </td>
                        ...
                        <td style="text-align: left">
                            <asp:TextBox ID="T_Delegacion" runat="server" CssClass="form-control" 
                                MaxLength="30" TabIndex="14" Width="80%"></asp:TextBox>
                        </td>
                        <td>
                            &nbsp;</td>
                    </tr>
                ...
                <table style="width:100%; margin-bottom: 1px;">
                    <tr>
                        <td width="11%">
                            &nbsp;</td>
                        <td style="text-align: left" width="10%">
                            <asp:Label ID="Label32" runat="server" CssClass="Textos_Azules" Text="País"></asp:Label>
                        </td>
                        <td width="7%">
                            <asp:TextBox ID="T_Pais" runat="server" CssClass="form-control" 
                                Width="32px" MaxLength="3" TabIndex="16"></asp:TextBox>
                        </td>
                        <td>
                        ...
                        <td style="text-align: left" class="style8">
                            <asp:TextBox ID="T_Desc_Pais" runat="server" CssClass="form-control" 
                                style="text-align: left" Width="205px" Enabled="False"></asp:TextBox>
                        </td>
                        ...
                        <td class="style10" style="text-align: left">
                            <asp:TextBox ID="T_CP" runat="server" CssClass="form-control" MaxLength="6" 
                                TabIndex="15" Width="75%"></asp:TextBox>
                        </td>
                        <td width="11%">
                            &nbsp;</td>
                    </tr>
                ...
                <table style="width:100%;">
                    <tr>
                        <td width="11%">
                            &nbsp;</td>
                        <td style="text-align: left" width="10%">
                            <asp:Label ID="Label33" runat="server" CssClass="Textos_Azules" Text="Teléfono"></asp:Label>
                        </td>
                        <td width="28%">
                            <asp:TextBox ID="T_Telefono" runat="server" CssClass="form-control" Width="80%" 
                                MaxLength="18" TabIndex="17"></asp:TextBox>
                        </td>
                        <td style="text-align: left" width="12%">
                            <asp:Label ID="Label34" runat="server" CssClass="Textos_Azules" Text="Fax"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="T_Fax" runat="server" CssClass="form-control" 
                                Width="80%" MaxLength="18" TabIndex="18"></asp:TextBox>
                        </td>
                        <td width="11%">
                            &nbsp;</td>
                    </tr>
                ...
                <table style="width:100%;">
                    <tr>
                        ...
                        <td height="40" width="16%" style="text-align: left">
                            <asp:Label ID="Label41" runat="server" CssClass="Textos_Azules" Text="Activa"></asp:Label>
                        </td>
                        <td style="text-align: left">
