<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Transporte.aspx.vb" Inherits="Transporte" %>
                                ...
                                <tr>
                                    ...
                                    <td width="70%">
                                        <asp:Panel ID="Panel1" runat="server" HorizontalAlign="Center">
                                            <asp:Label ID="Label25" runat="server" CssClass="Textos_Encabezado_Azul" Text="Catálogo Transporte" Width="95%"></asp:Label>
                                            <br />
                                        </asp:Panel>

                                    </td>
                                    <td style="text-align: right" width="15%">
                                        <asp:Image ID="Image1" runat="server" Height="61px" ImageUrl="~/Imagenes/logo_Inter_Original.jpg" style="text-align: right" Width="174px" />
                                        <br/>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table style="width:100%;">
                                <tr>
                                    ...
                                    <td style="text-align: center" width="80%">
                                        <asp:Button ID="Ima_Busca" runat="server" CssClass="Btn_Azul" Text="Busca" Width="90px" TabIndex="3" />
                                        <asp:Button ID="Ima_Alta" runat="server" CssClass="Btn_Azul" Text="Alta" Width="80px" />
                                        <asp:Button ID="Ima_Restaura" runat="server" CssClass="Btn_Azul" Text="Restaura" Width="110px" />
                                        <asp:Button ID="Ima_Guarda" runat="server" CssClass="Btn_Azul" Text="Guarda" Width="100px" TabIndex="7" />
                                ...
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>
                                        <asp:Label ID="Msg_Err" runat="server" BackColor="#FFFF99" BorderColor="Black" BorderStyle="Solid" ForeColor="#FF3300" style="float: none; text-align: center;" Text="Label" Visible="False" Width="96%"></asp:Label>
                                    </td>
                                    <td>&nbsp;</td>
                                </tr>
                            </table>
                                ...
                                <ContentTemplate>
                                    <table style="width:100%;">
                                        <tr>
                                            ...
                                            <td style="text-align: left" width="9%">
                                                <asp:TextBox ID="TB_Numero" runat="server" CssClass="form-control" Height="18px" placeholder="Num." style="text-align:right;" TabIndex="1" Width="80px"></asp:TextBox>
                                            </td>
                                            <td style="text-align: left" width="4%">&nbsp;</td>
                                            <td style="text-align: right; " width="35%">
                                                <asp:TextBox ID="TB_Nombre" runat="server" CssClass="form-control" Height="18px" placeholder="Descripcion" TabIndex="1" Width="220px"></asp:TextBox>
                                            </td>
                                            <td style="text-align: right; " width="30%">
                                                &nbsp;&nbsp;
                                                <asp:CheckBox ID="Ch_Baja" runat="server" AutoPostBack="True" CssClass="Textos_Azules" TabIndex="2" Text="Bajas" />
                                            </td>
                                            <td width="11%">&nbsp;</td>
                                        </tr>
                                        <tr>
                                    ...
                                    <asp:Panel ID="Pnl_Grids" runat="server" HorizontalAlign="Left" Visible="False">
                                        <div style="overflow:hidden; height:35px; width:100%; float:left" >
                                            <asp:GridView id="Cabecera" runat="server" AutoGenerateColumns="False" CellPadding="1" ForeColor="#333333" GridLines="None" ShowHeaderWhenEmpty="True" style="top: 152px; left: 86px; " Font-Size="Small"  Width="964px" Height="35px" CellSpacing="4">
                                        ...
                                        <div style="overflow-y:scroll; overflow-x:hidden; width:100%; height:500px;">
                                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                                ...
                                                Width="964px" Height="16px" CellSpacing="4" Visible="False" ShowHeader="False">
                                                <RowStyle BackColor="#EFF3FB" Height="22px" />
                                                <Columns>
                                                    ...
                                                    <asp:ButtonField ButtonType="Image" CommandName="Seleccion" HeaderText="Ver." ImageUrl="~/Imagenes/M_Selecciona_50.png" Text="Ver.">
