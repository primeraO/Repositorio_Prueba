<%@ Page Language="VB" AutoEventWireup="false" CodeFile="R_0003.aspx.vb" Inherits="R_0003" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function Proveedores1(elemValue1, elemValue2, elemValue3) {
            ...
            document.getElementById('<%= T_Prov_RFC_Ini.ClientID %>').value = elemValue3;
        ...
        function Proveedores2(elemValue1, elemValue2, elemValue3) {
            ...
            document.getElementById('<%= T_Prov_RFC_Fin.ClientID %>').value = elemValue3;
                        ...
                        <td width="60%">
                            <asp:Panel ID="Panel1" runat="server" Height="90px" HorizontalAlign="Center">
                                <asp:Label ID="Label25" runat="server" CssClass="Textos_Encabezado_Azul" 
                                    Height="40px" Text="Reporte Compras Por Proveedor"></asp:Label>
                                <br />
            ...
            <asp:Panel ID="Panel2" runat="server" CssClass="Paneles">
                ...
                <table style="width:100%;">
                    ...
                    <tr>
                        ...
                        <td width="5px">
                            <asp:TextBox ID="T_Prov_RFC_Ini" runat="server" 
                        ...
                        <td width="250px">
                            <asp:TextBox ID="T_Prov_RFC_Fin" runat="server" 
                                CssClass="form-control-Readonly" Width="140px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
