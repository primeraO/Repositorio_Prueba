<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Catalogo_Agente.aspx.vb" Inherits="Catalogo_Economico" %>
            ...
            <div>
                ...
                <asp:Panel ID="Panel1" runat="server" HorizontalAlign="Center">
                                    <asp:Label ID="Label25" runat="server" CssClass="Textos_Encabezado_Azul" 
                                        Text="Catálogo Agente" Width="95%"></asp:Label>
                                <br />
                                </asp:Panel>
                        ...
                        <div style="overflow:hidden; height:35px; width:100%; float:left">
                            <asp:GridView ID="Cabecera" runat="server" AutoGenerateColumns="False" 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Colonia">
                                    <HeaderStyle Width="120px" />
                                    </asp:BoundField>
                ...
                <asp:Panel ID="Pnl_Registro" CssClass="Paneles" runat="server">
                    <table style="width:100%;">
                        ...
                        <tr>
                            ...
                            <td style="text-align: left" height="40px">
                                <asp:TextBox ID="T_Mail" runat="server" CssClass="form-control" 
                                Width="80%"></asp:TextBox>
                            </td>
                            <td height="40px" style="text-align: left">
                                &nbsp;</td>
                        ...
                        <tr>
                            <td style="text-align: left" width="11%">
                                &nbsp;</td>
                            <td style="text-align: left" height="40px">
                                <asp:Label ID="Label30" runat="server" CssClass="Textos_Azules" Text="Colonia"></asp:Label>
                            </td>
                            <td style="text-align: left" height="40px">
                        ...
                        <tr>
                            <td style="text-align: left" width="11%">
                                &nbsp;</td>
                            <td style="text-align: left" height="40px">
                                <asp:Label ID="Label31" runat="server" CssClass="Textos_Azules" Text="Estado"></asp:Label>
                            </td>
                            <td style="text-align: left" height="40px">
