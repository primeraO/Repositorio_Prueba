...
Partial Class Catalogo_Terceros
    ...
    Private Sub CrearCamposTabla()
        ...
        Session("dt").Columns.Add("Tercero", Type.GetType("System.Int64")) : Session("dt").Columns("Tercero").DefaultValue = 0
        ...
        clave(0) = Session("dt").Columns("Tercero")
    ...
    Private Function validar() As Boolean
        ...
        End If
        If T_RFC.Text.Trim.Length < 12 Then
            Msg_Error("RFC inválido, debe contener minimo 12 caracteres") : Exit Function
        End If
        Return True
    End Function
    ...
    Private Sub AñadeFilaGrid(ByVal Numero As String, ByVal Descripcion As String, ByVal RFC As String)
        ...
        GridView1.DataBind()
    End Sub
    Private Sub CambiaFilaGrid(ByVal Numero As String, ByVal Descripcion As String, ByVal RFC As String)
    ...
    Protected Sub Ima_Guarda_Click(sender As Object, e As System.EventArgs) Handles Ima_Guarda.Click
        ...
        Try
            ...
            If Movimiento.Value = "Alta" Then
                Tsql = "Select Descripcion from Terceros where Descripcion=" & Pone_Apos(T_Descripcion.Text)
                ...
                AñadeFilaGrid(T_Numero.Text.Trim, T_Descripcion.Text.Trim, T_RFC.Text.Trim)
                LimpiaCampos()
            End If
            If Movimiento.Value = "Cambio" Then
                ...
                G.Tsql &= ",Baja=" & "''"
                G.Tsql &= " Where Tercero=" & Val(T_Numero.Text.Trim)
                G.com.CommandText = G.Tsql
                G.com.ExecuteNonQuery()
                CambiaFilaGrid(T_Numero.Text.Trim, T_Descripcion.Text.Trim, T_RFC.Text.Trim)
                If Ch_Baja.Checked = True Then
    ...
    Protected Sub GridView1_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles GridView1.SelectedIndexChanged
        Dim clave(0) As String
        clave(0) = GridView1.DataKeys(GridView1.SelectedIndex).Item("Tercero").ToString
        Dim f As DataRow = Session("dt").Rows.Find(clave)
        If Not f Is Nothing Then
            T_Numero.Text = f.Item("Tercero")
            T_Descripcion.Text = f.Item("Descripcion")
