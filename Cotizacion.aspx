...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        //Buscador de Cliente
        function BCliente(elemValue1, elemValue2, elemValue3) {
            document.getElementById('<%= TB_Cliente.ClientID %>').value = elemValue1;
            document.getElementById('<%= TB_Cliente_Razon_Social.ClientID %>').value = elemValue1;
            //document.getElementById('<%= TB_Cliente_RFC.ClientID %>').value = elemValue3;
            __doPostBack("TB_Cliente", "TextChanged");
        }
        //Buscardor de Cotizacion
        function BCotizacion(elemValue1, elemValue2) {
        ...
        function BArticulo(elemValue1, elemValue2) {
        ...
        //Buscar Cliente
        function Clientes(elemValue1, elemValue2, elemValue3) {
            ...
            //document.getElementById('<%= T_Cliente_RFC.ClientID %>').value = elemValue2;
                    ...
                    <tr>
                        ...
                        <td width="60%">
                            <asp:Panel ID="Panel1" runat="server" Height="90px" HorizontalAlign="Center">
                                <asp:Label ID="Label25" runat="server" CssClass="Textos_Encabezado_Azul" Height="40px" Text="Artículo - Proveedor"></asp:Label>
                                <br />
       ...
       <%-- <Triggers>
        <asp:PostBackTrigger ControlID="Movimiento" />
                ...
                <ContentTemplate>
                    ...
                    <div>
                        <asp:Label ID="Msg_Err" runat="server" BackColor="#FFFF99" BorderColor="Black" BorderStyle="Solid" ForeColor="#FF3300" 
               style="float: none; text-align: center;" Text="Label" Visible="False" Width="96%"></asp:Label>
                    </div>
                    <div style="height: 8px"></div>
                        ...
                        <div>
                            <table style="width:100%;">
                                <tr>
                                    ...
                                    <td width="300px">
                                        <asp:TextBox ID="TB_Cliente_RFC" runat="server" 
                        ...
                        <div>
                            <table style="width:100%;">
                                <tr>
                                    ...
                                    <td class="style8" width="250px">
                                        <asp:TextBox ID="T_Cliente_Razon_Social" runat="server" 
                                            CssClass="form-control-Readonly" Width="280px" ReadOnly="True"></asp:TextBox>
                                    </td>
                                    <td class="style8" width="150px">
                                        <asp:TextBox ID="T_Cliente_RFC" runat="server" CssClass="form-control-Readonly" 
                                            Width="140px" ReadOnly="True"></asp:TextBox>
                                    </td>
                                    <td class="style2" width="100px">
                                        <asp:Label ID="Label2" runat="server" CssClass="Textos_Azules" Text="Pedido"></asp:Label>
                                    </td>
                                    <td class="style9" width="50px">
                                        <asp:TextBox ID="T_Pedido" runat="server" CssClass="form-control-Readonly" 
                            ...
                            <table style="width:100%;">
                                <tr>
                                    ...
                                    <td width="100px">
                                        <asp:TextBox ID="T_Articulo" runat="server" CssClass="form-control" Width="100px" TabIndex="9"></asp:TextBox>
                                    </td>
                                    <td width="20px">
                                        <asp:ImageButton ID="Btn_Articulo" runat="server" 
                                            ImageUrl="~/Imagenes/M_Buscar_50.png" Width="29px" TabIndex="3000" />
                                    </td>
                                    <td width="300px">
                                        <asp:TextBox ID="T_Articulo_Descripcion" runat="server" 
                                            CssClass="form-control-Readonly" Width="280px" ReadOnly="True"></asp:TextBox>
                                    </td>
                            ...
                            <table style="width:100%;">
                                <tr>
                                    ...
                                    <td width="70px">
                                        <asp:TextBox ID="T_Unidad_Medida" runat="server" CssClass="form-control" Width="50px" MaxLength="5"  Style="text-transform: uppercase" TabIndex="10"></asp:TextBox>
                                    </td>
                                    <td class="style13" width="40px">&nbsp;</td>
                                    <td width="120px">
                                    ...
                                    <td width="100px">
                                        <asp:TextBox ID="T_Precio" runat="server" CssClass="form-control" Width="100px" 
                                    ...
                                    <td class="style15">
                                        <asp:TextBox ID="T_IVA" runat="server" CssClass="form-control" Width="40px" style="text-align:right;" TabIndex="15"></asp:TextBox>
                                    </td>
                                    <td class="style14">&nbsp;</td>
                                </tr>
                            </table>
                            <table style="width:100%;">
                                <tr>
                                    ...
                                    <td width="80px">
                                        <asp:TextBox ID="T_Marca" runat="server" CssClass="form-control" Width="100px" 
                                            style="text-align:right;" TabIndex="13"></asp:TextBox>
                                    </td>
                                    <td class="style20" width="80px">
                                        <asp:Label ID="Label58" runat="server" CssClass="Textos_Azules" Text="Linea"></asp:Label>
                                    </td>
                                    <td width="120px">
                                        <asp:TextBox ID="T_Linea" runat="server" CssClass="form-control" Width="100px" MaxLength="15" TabIndex="16"></asp:TextBox>
                                    </td>
                                    <td>
                        ...
                        <div style="overflow-y:scroll; overflow-x:hidden; width:100%; height:350px;">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Cliente" Visible="False" />
                    ...
                    <asp:Panel ID="Pnl_Grids2" runat="server" HorizontalAlign="Left" Visible="False">
                        <div style="overflow:hidden; height:35px; width:100%; float:left" >
                            <asp:GridView id="Cabecera2" runat="server" AutoGenerateColumns="False" CellPadding="1" ForeColor="#333333" GridLines="None" ShowHeaderWhenEmpty="True" style="top: 152px; left: 86px; " Font-Size="Small" Width="964px" Height="35px" CellSpacing="3">
                                <RowStyle BackColor="#EFF3FB" Height="22px" />
                                <Columns>
                        ...
                        <div style="overflow-y:scroll; overflow-x:hidden; width:100%; height:350px;">
                            <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
                                ...
                                <RowStyle BackColor="#EFF3FB" Height="22px" />
                                <Columns>
                                    <asp:BoundField DataField="Partida">
                                        <ItemStyle Width="100px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="Numero_Articulo">
                                        <ItemStyle Width="300px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="Descripcion_Articulo">
                                        <ItemStyle Width="300px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="Unidad_Medida" />
                                    <asp:BoundField DataField="Cantidad_Pedida" />
                                    <asp:BoundField DataField="Precio_Base" />
                                    <asp:BoundField DataField="Base_IVA" />
