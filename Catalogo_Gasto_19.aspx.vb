...
Partial Class Catalogo_Gasto_19
    ...
    Private Function LLena_Datatable() As DataTable
        ...
        Try
            ...
            G.cn.Open()
            G.Tsql = "Select Gasto,Descripcion from Gasto_19"
    ...
    Protected Sub GridView1_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridView1.SelectedIndexChanged
        ...
        clave(0) = GridView1.DataKeys(GridView1.SelectedIndex).Item("Gasto").ToString
        Dim f As DataRow = Session("dt").Rows.Find(clave)
        If Not f Is Nothing Then
            T_Numero.Text = f.Item("Gasto")
    ...
    Protected Sub Ima_Guarda_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Ima_Guarda.Click
        ...
        Try
            ...
            If Movimiento.Value = "Alta" Then
                T_Numero.Text = Siguiente()
                G.cn.Open()
                Tsql = "Select Descripcion from Gasto_19 where Descripcion=" & Pone_Apos(T_Descripcion.Text)
                ...
                End If
                G.Tsql = "Insert into Gasto_19 (Gasto,Descripcion,Fecha_Cambio,Baja) values ("
            ...
            If Movimiento.Value = "Cambio" Then
                G.cn.Open()
                G.Tsql = "Update Gasto_19 set Descripcion=" & Pone_Apos(T_Descripcion.Text.Trim)
    ...
    Private Function Siguiente() As Integer
        ...
        Try
            G.cn.Open()
            G.Tsql = "Select Max(Gasto) from Gasto_19"
            G.com.CommandText = G.Tsql
