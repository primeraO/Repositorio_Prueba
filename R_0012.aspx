<%@ Page Language="VB" AutoEventWireup="false" CodeFile="R_0012.aspx.vb" Inherits="R_0012" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function Solicitante(elemValue1, elemValue2) {
            document.getElementById('<%= T_Solicitante.ClientID %>').value = elemValue1;
            document.getElementById('<%= T_Solicitante_Nombre.ClientID %>').value = elemValue2;
            __doPostBack("T_Solicitante", "TextChanged");
        }
    </script>
                        ...
                        <td width="60%">
                            <asp:Panel ID="Panel1" runat="server" Height="90px" HorizontalAlign="Center">
                                <asp:Label ID="Label25" runat="server" CssClass="Textos_Encabezado_Azul" 
                                    Height="40px" Text="Reporte Entradas Por Solicitante"></asp:Label>
                                <br />
                ...
                <asp:Panel ID="Panel2" runat="server" CssClass="Paneles">
                    ...
                    <table style="width:100%;">
                        ...
                        <tr>
                            ...
                            <td width="100px">
                                <asp:TextBox ID="T_Solicitante" runat="server" AutoPostBack="True" 
                                    CssClass="form-control" Width="100px"></asp:TextBox>
                            </td>
                            <td width="20px">
                            ...
                            <td width="250px">
                                <asp:TextBox ID="T_Solicitante_Nombre" runat="server" 
                                    CssClass="form-control-Readonly" Width="255px"></asp:TextBox>
                            </td>
                            <td width="5px">
                            </td>
