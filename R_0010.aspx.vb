...
Partial Class R_0010
    ...
    Protected Sub Ima_Imprimir_Click(sender As Object, e As System.EventArgs) Handles Ima_Imprimir.Click
        ...
        'Script = "<script type='text/javascript'>window.open('Visor_Reporte.aspx?Reporte=R_0010&LinI="
        'Script &= T_Linea_Inicial.Text.Trim & "&LinF=" & T_Linea_Final.Text.Trim & "&D=" & T_Dias.Text.Trim & "');</script>"
    ...
    Protected Sub Btn_Acepta_Imp_Click(sender As Object, e As System.EventArgs) Handles Btn_Acepta_Imp.Click
        ...
        Div.Attributes.Remove("Class")
            Dim Script As String = ""
        Script = "<script type='text/javascript'>window.open('Visor_Reporte.aspx?" & Impresora & "Reporte=R_0010&LinI="
            Script &= T_Linea_Inicial.Text.Trim & "&LinF=" & T_Linea_Final.Text.Trim & "&D=" & T_Dias.Text.Trim & "');</script>"
            Response.Write(Script)
    End Sub
