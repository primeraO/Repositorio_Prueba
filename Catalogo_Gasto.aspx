<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Catalogo_Gasto.aspx.vb" Inherits="Catalogo_Gasto" %>
            ...
            <div>
                ...
                <asp:Panel ID="Panel1" runat="server" HorizontalAlign="Center">
                                    <asp:Label ID="Label25" runat="server" CssClass="Textos_Encabezado_Azul" 
                                        Text="Catálogo Gasto" Width="95%"></asp:Label>
                                <br />
                                </asp:Panel>
                            ...
                            <tr style="height: 40px">
                                ...
                                <td style="text-align: left" width="9%">
                                    <asp:TextBox ID="TB_Numero" runat="server" CssClass="form-control" 
                                        placeholder="Núm" style="text-align:right;" TabIndex="1" Width="56px"></asp:TextBox>
                                </td>
                        ...
                        <asp:Panel ID="Pnl_Grids" runat="server" HorizontalAlign="Left" Visible="False">
                            ...
                            <div style="overflow-y:scroll; overflow-x:hidden; width:100%; height:500px;">
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                    CellPadding="2" CellSpacing="4" DataKeyNames="Gasto" Font-Size="Small" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Gasto" HeaderText="Núm.">
