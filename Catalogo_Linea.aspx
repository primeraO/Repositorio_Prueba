<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Catalogo_Linea.aspx.vb" Inherits="Catalogo_Linea" %>
...
<link href="Ejemplo_Estilos.css" rel="stylesheet" type="text/css" />
    ...
    <script language="javascript" type="text/javascript">
        function Responsable(elemValue1, elemValue2) {
            document.getElementById('T_Responsable').value = elemValue1;
            document.getElementById('T_Nombre_Responsable').value = elemValue2;
            __doPostBack("T_Responsable", "TextChanged");
        }
    </script>
            ...
            <div>
                ...
                <asp:Panel ID="Panel1" runat="server" HorizontalAlign="Center">
                                    <asp:Label ID="Label25" runat="server" CssClass="Textos_Encabezado_Azul" 
                                        Text="Catálogo Grupo" Width="95%"></asp:Label>
                                <br />
                                </asp:Panel>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left" width="9%">
                                <asp:TextBox ID="TB_Numero" runat="server" CssClass="form-control" 
                                    Height="18px" placeholder="Num" style="text-align:right;" TabIndex="13" 
                            ...
                            <td style="text-align: right; " width="35%">
                                <asp:TextBox ID="TB_Descripcion" runat="server" CssClass="form-control" 
                                    Height="18px" placeholder="Descripción de Linea" TabIndex="14" Width="327px"></asp:TextBox>
                            </td>
                        ...
                        <div style="overflow:hidden; height:35px; width:100%; float:left">
                            <asp:GridView ID="Cabecera" runat="server" AutoGenerateColumns="False" 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Aplicación" Visible="False">
                                    <HeaderStyle Width="200px" />
                                    </asp:BoundField>
                                    <asp:BoundField HeaderText="Nombre Responsable" Visible="False">
                                    <HeaderStyle Width="200px" />
                                    </asp:BoundField>
                                    <asp:BoundField HeaderText="Ver" Visible="False">
                ...
                <asp:Panel ID="Pnl_Registro" CssClass="Paneles" runat="server">
                        ...
                        <tr>
                            ...
                            <td height="40px" style="text-align: left" width="90px">
                                <asp:TextBox ID="T_Numero" runat="server" CssClass="form-control" Height="18px" 
                                    ...
                                    style="text-align:right;top: 493px; left: 645px; " TabIndex="1" Width="55px"></asp:TextBox>
                            </td>
                            <td height="40px" style="text-align: right" width="90px">
                                <asp:Label ID="Label17" runat="server" BorderStyle="None" 
                                    CssClass="Textos_Azules" Text="Grupo:"></asp:Label>
                            </td>
                            <td height="40px" style="text-align: left" width="210px">
                                <asp:TextBox ID="T_Descripcion" runat="server" CssClass="form-control" 
                                    Height="18px" MaxLength="35" 
                                    style="top: 550px; left: 155px; right: 66px; bottom: 70px;" TabIndex="2" 
                                    Width="180px"></asp:TextBox>
                            </td>
                            <td height="40px" style="text-align: right" width="90px">
                                <asp:Label ID="Label24" runat="server" BorderStyle="None" 
                                    CssClass="Textos_Azules" Text="Aplicación:" Visible="False"></asp:Label>
                            </td>
                            <td height="40px" style="text-align: left" width="245px">
                                <asp:TextBox ID="T_Aplicacion" runat="server" CssClass="form-control" 
                                    Height="18px" MaxLength="35" style="top: 481px; left: 10px; text-align: left;" 
                                    TabIndex="3" Width="200px" Visible="False"></asp:TextBox>
                            </td>
                    ...
                    <table style="width:100%; height: 40px;">
                        <tr>
                            ...
                            <td width="30px">
                                &nbsp;</td>
                            <td style="text-align: left" width="654">
                                &nbsp;</td>
                            <td width="100">
                                &nbsp;</td>
                        </tr>
