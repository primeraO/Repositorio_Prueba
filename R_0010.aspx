<%@ Page Language="VB" AutoEventWireup="false" CodeFile="R_0010.aspx.vb" Inherits="R_0010" %>
                        ...
                        <td width="60%">
                            <asp:Panel ID="Panel1" runat="server" Height="90px" HorizontalAlign="Center">
                                <asp:Label ID="Label25" runat="server" CssClass="Textos_Encabezado_Azul" 
                                    Height="40px" Text="Reporte Lento Movimiento"></asp:Label>
                                <br />
        ...
        <div>
                ...
                <asp:Panel ID="Panel2" runat="server" CssClass="Paneles">
                    ...
                    <table style="width:100%;">
                        ...
                        <tr>
                            <td width="90px">
                                <asp:Label ID="Label32" runat="server" CssClass="Textos_Azules" Text="Días"></asp:Label>
                            </td>
                            <td width="100px">
                                <asp:TextBox ID="T_Dias" runat="server" AutoPostBack="True" 
                                    CssClass="form-control" Width="50px">30</asp:TextBox>
                            </td>
                            <td width="20px">
                                &nbsp;</td>
                            <td width="250px">
