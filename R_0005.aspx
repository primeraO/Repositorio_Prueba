<%@ Page Language="VB" AutoEventWireup="false" CodeFile="R_0005.aspx.vb" Inherits="R_0005" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function Proveedores1(elemValue1, elemValue2, elemValue3) {
            document.getElementById('<%= T_Proveedor_Inicial.ClientID %>').value = elemValue1;
            document.getElementById('<%= T_Prov_Nom_Inicial.ClientID %>').value = elemValue2;
            document.getElementById('<%= T_Prov_Nom_RFC_Ini.ClientID %>').value = elemValue3;
            
            __doPostBack("T_Proveedor_Inicial", "TextChanged");
        }
        function Proveedores2(elemValue1, elemValue2, elemValue3) {
            document.getElementById('<%= T_Proveedor_Final.ClientID %>').value = elemValue1;
            document.getElementById('<%= T_Prov_Nom_Final.ClientID %>').value = elemValue2;
            document.getElementById('<%= T_Prov_Nom_RFC_Fin.ClientID %>').value = elemValue3;
            __doPostBack("T_Proveedor_Final", "TextChanged");
        }
        

        function Clave_Movimientos_Inventario(elemValue1, elemValue2) {
            document.getElementById('<%= T_Movimiento.ClientID %>').value = elemValue1;
            document.getElementById('<%= T_Movimiento_Descripcion.ClientID %>').value = elemValue2;
            __doPostBack("T_Movimiento", "TextChanged");
        }
    </script>
...
<body>
<center>
    <form id="form1" runat="server" style="width:1360px;">
                        ...
                        <td width="60%">
                            <asp:Panel ID="Panel1" runat="server" Height="90px" HorizontalAlign="Center">
                                <asp:Label ID="Label25" runat="server" CssClass="Textos_Encabezado_Azul" 
                                    Height="40px" Text="Reporte Devoluciones Por Proveedor"></asp:Label>
                                <br />
                ...
                <asp:Panel ID="Panel2" runat="server" CssClass="Paneles">
                    ...
                    <table style="width:100%;">
                        ...
                        <tr>
                            ...
                            <td width="5%">
                                <asp:TextBox ID="T_Movimiento" runat="server" CssClass="form-control" 
                                    Width="100px"></asp:TextBox>
                            </td>
                            <td width="20px">
                                <asp:ImageButton ID="Btn_Movimiento" runat="server" 
                                    ImageUrl="~/Imagenes/M_Buscar_50.png" TabIndex="5" Width="29px" />
                            </td>
                            <td>
                                <asp:TextBox ID="T_Movimiento_Descripcion" runat="server" 
                        ...
                        <tr>
                            ...
                            <td width="5%">
                                <asp:TextBox ID="T_Proveedor_Inicial" runat="server" AutoPostBack="True" 
                                    CssClass="form-control" Width="100px"></asp:TextBox>
                            </td>
                            <td width="20px">
                                <asp:ImageButton ID="Btn_Proveedor_Inicial" runat="server" 
                                    ImageUrl="~/Imagenes/M_Buscar_50.png" TabIndex="5" Width="29px" />
                            </td>
                            <td>
                                <asp:TextBox ID="T_Prov_Nom_Inicial" runat="server" 
                                    CssClass="form-control-Readonly" Width="255px"></asp:TextBox>
                            </td>
                            <td width="5px">
                                <asp:TextBox ID="T_Prov_Nom_RFC_Ini" runat="server" 
                                    CssClass="form-control-Readonly" Width="140px"></asp:TextBox>
                            </td>
                            <td width="100px">
                                <asp:TextBox ID="T_Proveedor_Final" runat="server" AutoPostBack="True" 
                                    CssClass="form-control" Width="100px"></asp:TextBox>
                            </td>
                            <td width="20px">
                                <asp:ImageButton ID="Btn_Proveedor_Final" runat="server" 
                                    CssClass="Btn_Proveedor" ImageUrl="~/Imagenes/M_Buscar_50.png" TabIndex="5" 
                                    Width="29px" />
                            </td>
                            <td width="250px">
                                <asp:TextBox ID="T_Prov_Nom_Final" runat="server" 
                                    CssClass="form-control-Readonly" Width="255px"></asp:TextBox>
                            </td>
                            <td width="250px">
                                <asp:TextBox ID="T_Prov_Nom_RFC_Fin" runat="server" 
                                    CssClass="form-control-Readonly" Width="140px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
