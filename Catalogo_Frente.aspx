<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Catalogo_Frente.aspx.vb" Inherits="Catalogo_Frente" %>
            ...
            <div>
                ...
                <asp:Panel ID="Panel1" runat="server" HorizontalAlign="Center">
                                    <asp:Label ID="Label25" runat="server" CssClass="Textos_Encabezado_Azul" 
                                        Text="Catálogo Frente" Width="95%"></asp:Label>
                                <br />
                                </asp:Panel>
                    ...
                    <table style="width:100%;">
                        <tr>
                            ...
                            <td style="text-align: right; " width="35%">
                                ...
                                placeholder="Frente" CssClass="form-control" MaxLength="50"></asp:TextBox>
                            </td>
                    ...
                    <asp:Panel ID="Pnl_Grids" runat="server" HorizontalAlign="Left" Visible="False">
                        ...
                        <div style="overflow-y:scroll; overflow-x:hidden; width:100%; height:500px;">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                CellPadding="2" CellSpacing="4" DataKeyNames="Frente" Font-Size="Small" 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Frente" HeaderText="Núm.">
                                    <ItemStyle HorizontalAlign="Right" Width="50px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="Descripcion" HeaderText="Frente">
                ...
                <asp:Panel ID="Pnl_Registro" CssClass="Paneles" runat="server">
                 ...
                 style="text-align:right;top: 493px; left: 645px; " MaxLength="4" TabIndex="1" 
                            ...
                            <td style="text-align: right" height="40px" width="50px">
                                <asp:Label ID="Label17" runat="server" BorderStyle="None" Text="Frente:" 
                                CssClass="Textos_Azules"></asp:Label>
                            </td>
                    ...
                    MaxLength="50" TabIndex="17" CssClass="form-control" Width="180px"></asp:TextBox>
                            </td>
