...
Partial Class Catalogo_Condicion_Pago
    ...
    Private Sub CrearCamposTabla()
        ...
        Session("dt").Columns.Add("Condicion", Type.GetType("System.Int64")) : Session("dt").Columns("Condicion").DefaultValue = 0
        ...
        clave(0) = Session("dt").Columns("Condicion")
    ...
    Private Function LLena_Datatable() As DataTable
        ...
        Try
            ...
            G.cn.Open()
            G.Tsql = "Select Numero as Condicion,Descripcion from Condicion_Pago "
    ...
    Private Function Siguiente() As Integer
        ...
        Try
            G.cn.Open()
            G.Tsql = "Select Max(Numero) from Condicion_Pago"
            G.Tsql &= " where Cia=" & Val(Session("Cia"))
            G.Tsql &= " and Sucursal=" & Pone_Apos(Session("Obra"))
            G.com.CommandText = G.Tsql
    ...
    Protected Sub Ima_Guarda_Click(sender As Object, e As System.EventArgs) Handles Ima_Guarda.Click
        ...
        Try
            ...
            If Movimiento.Value = "Alta" Then
                ' T_Numero.Text = Siguiente()
                G.cn.Open()
                Tsql = "Select Descripcion from Condicion_Pago where Descripcion=" & Pone_Apos(T_Descripcion.Text)
                G.com.CommandText = Tsql
                If Not G.com.ExecuteScalar Is Nothing Then
                    Msg_Error("Ya existe el Nombre de la condicion") : Exit Sub
                End If
                Tsql = "Select Numero from Condicion_Pago where Numero=" & Val(T_Numero.Text)
                G.com.CommandText = Tsql
                If Not G.com.ExecuteScalar Is Nothing Then
    ...
    Protected Sub GridView1_RowCommand(sender As Object, e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridView1.RowCommand
        If (e.CommandName.Equals("Baja")) Or (e.CommandName.Equals("Cambio")) Or (e.CommandName.Equals("Seleccion")) Then
            ...
            Dim f As DataRow = Session("dt").Rows.Find(Clave)
            If Not f Is Nothing Then
                T_Numero.Text = f.Item("Condicion")
    ...
    Protected Sub GridView1_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles GridView1.SelectedIndexChanged
        Dim clave(0) As String
        clave(0) = GridView1.DataKeys(GridView1.SelectedIndex).Item("Condicion").ToString
        Dim f As DataRow = Session("dt").Rows.Find(clave)
        If Not f Is Nothing Then
            T_Numero.Text = f.Item("Condicion")
            T_Descripcion.Text = f.Item("Descripcion")
